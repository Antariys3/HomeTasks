...
class Truck(Auto):
    def __init__(self, brand, age, mark, max_load, color="black", weight=6800):
...
class Car(Auto):
    def __init__(self, brand, age, mark, max_speed, color="white", weight=1600):
        super().__init__(brand, age, mark, color, weight)
